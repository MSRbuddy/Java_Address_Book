...
class AddressBook5 extends AddressBookUC5
{
    Scanner sc = new Scanner(System.in);

    ArrayList<Contact5> contactArrayList = new ArrayList<Contact5>();
    ...
    public void displayContact() {
        ...
        for(int i = 0; i < contactArrayList.size(); i++ ) {
            Contact5 contact = contactArrayList.get(i);
    ...
    public void editContact() {
        ...
        for (Contact5 contact : contactArrayList) {
