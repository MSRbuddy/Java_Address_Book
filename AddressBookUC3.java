...
class AddressBook3
{
    ...
    ArrayList<Contact3> contactArrayList = new ArrayList<Contact3>();

    public void addContact()
    {
        // creating object of Contact class
        Contact3 contact = new Contact3();
    ...
    public void displayContact()
    {
        ...
        for(int i = 0; i < contactArrayList.size(); i++ ) {
            Contact3 contact = contactArrayList.get(i);
    ...
    public void editContact() {
        ...
        for(Contact3 contact : contactArrayList) {
